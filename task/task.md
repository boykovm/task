...
1. Сервіс має відповідати описаному [API](https://mykhailo-hrynko.github.io/se-school/task/description.html) у вигляді Swagger-документації. Для зручного перегляду можна скористатися сервісом https://editor.swagger.io/. Змінювати контракти не можна.
